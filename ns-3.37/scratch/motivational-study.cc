...
/*
 * Enable the logs of the file by enabling the component "RanExample1",
 * in this way:
 * $ export NS_LOG="RanExample1=level_info|prefix_func|prefix_time"
 */
NS_LOG_COMPONENT_DEFINE("RanExample1");
